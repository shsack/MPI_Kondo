...
def main(epsImp, epsCav):
    ...
    H = _.MPO(numberOfSites=len(mpo.Hamiltonian), bondDimension=6, localHilbertSpace=4, maximalBondDimension=D,
    ...
    groundState = _.mpsDMRG(H, bondDimension=D, thresholdEntanglement=1e-6)
    groundState.groundState(sweeps=5)

    length_new = len(groundState.M)

    dot_up =  _.MPO(numberOfSites=length_new, bondDimension=1, localHilbertSpace=4, maximalBondDimension=D,
                    thresholdEntanglement=0., periodic=False)
    ...
    dot_down =  _.MPO(numberOfSites=length_new, bondDimension=1, localHilbertSpace=4, maximalBondDimension=D,
                      thresholdEntanglement=0., periodic=False)
    ...
    cav_up =  _.MPO(numberOfSites=length_new, bondDimension=1, localHilbertSpace=4, maximalBondDimension=D,
                    thresholdEntanglement=0., periodic=False)
    ...
    cav_down =  _.MPO(numberOfSites=length_new, bondDimension=1, localHilbertSpace=4, maximalBondDimension=D,
                      thresholdEntanglement=0., periodic=False)
